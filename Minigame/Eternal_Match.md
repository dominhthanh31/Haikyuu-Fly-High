...
![士気アップ](../Ảnh/Eternal/士気アップ.png)

- [Tinh thần đội] khởi điểm của phe ta là **120**.

#### 士気の鼓舞 — Khích Lệ Sĩ Khí

![士気の鼓舞](../Ảnh/Eternal/士気の鼓舞.png)

- Thời gian duy trì [Tinh thần đội giác ngộ] của phe ta tăng thêm **8** lần.

#### 勢いで制す — Chế Ngự Bằng Khí Thế

![勢いで制す](../Ảnh/Eternal/勢いで制す.png)

- Trong khi phe ta đang kích hoạt [Tinh thần đội giác ngộ], chỉ số chính của thành viên phe ta tăng **50%**.

#### 燃える闘志 — Ý Chí Bùng Cháy

![燃える闘志](../Ảnh/Eternal/燃える闘志.png)

- Khi thành viên phe ta chạm bóng, [Tinh thần đội] của phe ta tăng **5** và [Đập mạnh] của thành viên đang có hiệu ứng [Phong Độ Tuyệt Đỉnh] tăng **80%**. *(Nội tại của Bokuto)*

#### 意気込み — Quyết Tâm

![意気込み](../Ảnh/Eternal/意気込み.png)

- Khi kết thúc rally, [Tinh thần đội] của phe ta tăng **30**. Cứ **2 rally** 1 lần, khi một thành viên phe ta nhận hiệu ứng [Thăng Trầm], hiệu ứng đó bị giải trừ ngay. *(Nội tại của Bokuto)*

### Tấn Công

#### 猛烈な攻撃 — Tấn Công Mãnh Liệt

![猛烈な攻撃](../Ảnh/Eternal/猛烈な攻撃.png)
...
![強打のバフ](../Ảnh/Eternal/強打のバフ.png)

- Số lượng tag [Đập mạnh] của phe ta tăng thêm **2**.
- Hiệu ứng đặc tính tăng **20%**.
...
![レシーブのバフ](../Ảnh/Eternal/レシーブのバフ.png)

- Số lượng tag [Đỡ bóng] của phe ta tăng thêm **2**.
- Hiệu ứng đặc tính tăng **20%**.

#### 堅牢な守備 — Phòng Thủ Kiên Cố

![堅牢な守備](../Ảnh/Eternal/堅牢な守備.png)

- Khi Libero phe ta không có mặt trên sân, [Đỡ bóng] của hàng sau phe ta tăng **70%**.

#### 優れた実力 — Thực Lực Vượt Trội

![優れた実力](../Ảnh/Eternal/優れた実力.png)
...
![逆風を乗り越える](../Ảnh/Eternal/逆風を乗り越える.png)
